...
public class Page6_GPA2 extends JFrame {
...
private JPanel contentPane;
	...
	private JTextField textResultC1Y2;
	...
	private JTextField textResultC2Y2;
	...
	private JTextField textResultG1Y2;
	private JTextField textResultG2Y2;
	private JTextField textTerm1Y2;
	private JTextField textTerm2Y2;
	...
	public Page6_GPA2() {
		...
		btnDoneT1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textResultC1Y2.setText(String.valueOf(SumC1));
				textResultG1Y2.setText(String.valueOf(SumG1));
		...
		btnDoneT5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textResultC2Y2.setText(String.valueOf(SumC2));
				textResultG2Y2.setText(String.valueOf(SumG2));
			}
		});
		...
		JPanel panelResultY2 = new JPanel();
		panelResultY2.setBounds(170, 490, 816, 250);
		contentPane.add(panelResultY2);
		panelResultY2.setLayout(null);
		
		textResult2 = new JTextField();
		textResult2.setEditable(false);
		textResult2.setHorizontalAlignment(SwingConstants.CENTER);
		textResult2.setFont(new Font("Dialog", Font.PLAIN, 25));
		textResult2.setBounds(360, 207, 100, 30);
		panelResultY2.add(textResult2);
		...
		panelResultY2.add(lblGPAX);
		
		textTerm1Y2 = new JTextField();
		textTerm1Y2.setHorizontalAlignment(SwingConstants.CENTER);
		textTerm1Y2.setFont(new Font("Dialog", Font.PLAIN, 25));
		textTerm1Y2.setEditable(false);
		textTerm1Y2.setColumns(10);
		textTerm1Y2.setBounds(510, 60, 100, 30);
		panelResultY2.add(textTerm1Y2);
		
		JLabel lblTerm = new JLabel("Term 1");
		lblTerm.setFont(new Font("Wide Latin", Font.PLAIN, 20));
		lblTerm.setBounds(12, 60, 127, 30);
		panelResultY2.add(lblTerm);
		
		textTerm2Y2 = new JTextField();
		textTerm2Y2.setHorizontalAlignment(SwingConstants.CENTER);
		textTerm2Y2.setFont(new Font("Dialog", Font.PLAIN, 25));
		textTerm2Y2.setEditable(false);
		textTerm2Y2.setColumns(10);
		textTerm2Y2.setBounds(510, 120, 100, 30);
		panelResultY2.add(textTerm2Y2);
		
		JLabel lblTerm2 = new JLabel("Term 2");
		lblTerm2.setFont(new Font("Wide Latin", Font.PLAIN, 20));
		lblTerm2.setBounds(12, 120, 127, 30);
		panelResultY2.add(lblTerm2);
		
		textResultC1Y2 = new JTextField();
		textResultC1Y2.setBounds(190, 60, 100, 30);
		panelResultY2.add(textResultC1Y2);
		textResultC1Y2.setHorizontalAlignment(SwingConstants.CENTER);
		textResultC1Y2.setEditable(false);
		textResultC1Y2.setFont(new Font("Dialog", Font.PLAIN, 25));
		textResultC1Y2.setColumns(10);
		
		textResultC2Y2 = new JTextField();
		textResultC2Y2.setBounds(190, 120, 100, 30);
		panelResultY2.add(textResultC2Y2);
		textResultC2Y2.setHorizontalAlignment(SwingConstants.CENTER);
		textResultC2Y2.setFont(new Font("Dialog", Font.PLAIN, 25));
		textResultC2Y2.setEditable(false);
		textResultC2Y2.setColumns(10);
		
		textResultG1Y2 = new JTextField();
		textResultG1Y2.setBounds(350, 60, 100, 30);
		panelResultY2.add(textResultG1Y2);
		textResultG1Y2.setHorizontalAlignment(SwingConstants.CENTER);
		textResultG1Y2.setFont(new Font("Dialog", Font.PLAIN, 25));
		textResultG1Y2.setEditable(false);
		textResultG1Y2.setColumns(10);
		
		textResultG2Y2 = new JTextField();
		textResultG2Y2.setBounds(350, 120, 100, 30);
		panelResultY2.add(textResultG2Y2);
		textResultG2Y2.setHorizontalAlignment(SwingConstants.CENTER);
		textResultG2Y2.setFont(new Font("Dialog", Font.PLAIN, 25));
		textResultG2Y2.setEditable(false);
		textResultG2Y2.setColumns(10);
		
		JButton btnCheck1 = new JButton("");
		btnCheck1.setBounds(749, 182, 55, 55);
		panelResultY2.add(btnCheck1);
		btnCheck1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textResult2.setText(String.valueOf(result.format(Result1)) ); 
				...
				t1.format(term1);
				textTerm1Y2.setText(String.valueOf(t1.format(term1)));
				DecimalFormat t2 = new DecimalFormat("#.##");
				t2.format(term2);
				textTerm2Y2.setText(String.valueOf(t2.format(term2)));
		...
		btnNew.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String A3 = textResultC1Y2.getText();
				String A4 = textResultC2Y2.getText();
				String B3 = textResultG1Y2.getText();
				String B4 = textResultG2Y2.getText();
				String R2 = textResult2.getText();
				gpa3.setA1(A3);
				gpa3.setA2(A4);
				gpa3.setB1(B3);
				gpa3.setB2(B4);
