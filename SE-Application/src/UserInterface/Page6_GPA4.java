...
public class Page6_GPA4 extends JFrame {
...
private JPanel contentPane;
	...
	private JTextField textResultC1Y4;
	...
	private JTextField textResultC2Y4;
	...
	private JTextField textResult4;
	private JButton button;
	private JTextField textResultG1Y4;
	private JTextField textResultG2Y4;
	private JTextField textTerm1Y4;
	private JTextField textTerm2Y4;
	...
	public Page6_GPA4() {
		...
		btnDoneT1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textResultC1Y4.setText(String.valueOf(SumC1));
				textResultG1Y4.setText(String.valueOf(SumG1));
		...
		btnDoneT5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textResultC2Y4.setText(String.valueOf(SumC2));
				textResultG2Y4.setText(String.valueOf(SumG2));
			}
		});
		...
		JPanel panelResultY4 = new JPanel();
		panelResultY4.setBounds(170, 490, 816, 250);
		contentPane.add(panelResultY4);
		panelResultY4.setLayout(null);
		
		textResult4 = new JTextField();
		textResult4.setEditable(false);
		textResult4.setHorizontalAlignment(SwingConstants.CENTER);
		textResult4.setFont(new Font("Dialog", Font.PLAIN, 25));
		textResult4.setBounds(360, 207, 100, 30);
		panelResultY4.add(textResult4);
		textResult4.setColumns(10);
		
		JLabel lblGPAX = new JLabel("GPAX");
		lblGPAX.setFont(new Font("Wide Latin", Font.PLAIN, 25));
		lblGPAX.setBounds(337, 177, 140, 30);
		panelResultY4.add(lblGPAX);
		
		textTerm1Y4 = new JTextField();
		textTerm1Y4.setHorizontalAlignment(SwingConstants.CENTER);
		textTerm1Y4.setFont(new Font("Dialog", Font.PLAIN, 25));
		textTerm1Y4.setEditable(false);
		textTerm1Y4.setColumns(10);
		textTerm1Y4.setBounds(510, 60, 100, 30);
		panelResultY4.add(textTerm1Y4);
		
		JLabel lblTerm = new JLabel("Term 1");
		lblTerm.setFont(new Font("Wide Latin", Font.PLAIN, 20));
		lblTerm.setBounds(12, 60, 127, 30);
		panelResultY4.add(lblTerm);
		
		textTerm2Y4 = new JTextField();
		textTerm2Y4.setHorizontalAlignment(SwingConstants.CENTER);
		textTerm2Y4.setFont(new Font("Dialog", Font.PLAIN, 25));
		textTerm2Y4.setEditable(false);
		textTerm2Y4.setColumns(10);
		textTerm2Y4.setBounds(510, 120, 100, 30);
		panelResultY4.add(textTerm2Y4);
		
		JLabel lblTerm2 = new JLabel("Term 2");
		lblTerm2.setFont(new Font("Wide Latin", Font.PLAIN, 20));
		lblTerm2.setBounds(12, 120, 127, 30);
		panelResultY4.add(lblTerm2);
		
		textResultC1Y4 = new JTextField();
		textResultC1Y4.setBounds(190, 60, 100, 30);
		panelResultY4.add(textResultC1Y4);
		textResultC1Y4.setHorizontalAlignment(SwingConstants.CENTER);
		textResultC1Y4.setEditable(false);
		textResultC1Y4.setFont(new Font("Dialog", Font.PLAIN, 25));
		textResultC1Y4.setColumns(10);
		
		textResultC2Y4 = new JTextField();
		textResultC2Y4.setBounds(190, 120, 100, 30);
		panelResultY4.add(textResultC2Y4);
		textResultC2Y4.setHorizontalAlignment(SwingConstants.CENTER);
		textResultC2Y4.setFont(new Font("Dialog", Font.PLAIN, 25));
		textResultC2Y4.setEditable(false);
		textResultC2Y4.setColumns(10);
		
		textResultG1Y4 = new JTextField();
		textResultG1Y4.setBounds(350, 60, 100, 30);
		panelResultY4.add(textResultG1Y4);
		textResultG1Y4.setHorizontalAlignment(SwingConstants.CENTER);
		textResultG1Y4.setFont(new Font("Dialog", Font.PLAIN, 25));
		textResultG1Y4.setEditable(false);
		textResultG1Y4.setColumns(10);
		
		textResultG2Y4 = new JTextField();
		textResultG2Y4.setBounds(350, 120, 100, 30);
		panelResultY4.add(textResultG2Y4);
		textResultG2Y4.setHorizontalAlignment(SwingConstants.CENTER);
		textResultG2Y4.setFont(new Font("Dialog", Font.PLAIN, 25));
		textResultG2Y4.setEditable(false);
		textResultG2Y4.setColumns(10);
		
		JButton btnCheck1 = new JButton("");
		btnCheck1.setBounds(749, 182, 55, 55);
		panelResultY4.add(btnCheck1);
		btnCheck1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textResult4.setText(String.valueOf(result.format(Result1)) ); 
				...
				t1.format(term1);
				textTerm1Y4.setText(String.valueOf(t1.format(term1)));
				DecimalFormat t2 = new DecimalFormat("#.##");
				t2.format(term2);
				textTerm2Y4.setText(String.valueOf(t2.format(term2)));
		...
		btnNew.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String A7 = textResultC1Y4.getText();
				String A8 = textResultC2Y4.getText();
				String B7 = textResultG1Y4.getText();
				String B8 = textResultG2Y4.getText();
				String R4 = textResult4.getText();
				re.setA7(A7);
				re.setA8(A8);
				re.setB7(B7);
				re.setB8(B8);
